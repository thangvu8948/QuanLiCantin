...
add	constraint FK_NV_LTK foreign key(LoaiNV) references LoaiTaiKhoan(LoaiTK),
constraint FK_NV_TK foreign key(TenDN) references TaiKhoan(ID);
...
values ('N0001','HH001','2019-11-16',30,10000,300000),
		...
		Select * from NhanVien where TenDN = 'admin' and LoaiNV= 1 and MatKhau='admin'